...
let LEFT, UP, RIGHT, DOWN, MOUSEMOVE, MOUSEDOWN;
let friction = 0;
...
for (let addBody = 0; addBody < 1; addBody++) {
    let x0 = randInt(100, canvas.clientWidth - 150);
    let y0 = randInt(100, canvas.clientHeight - 150);
    let x1 = x0 + randInt(100, 150);
    let y1 = y0 + randInt(100, 150);
    let r = randInt(70, 100);
    let m = randInt(1, 1);
...
let playerBall = new Ball(320, 240, 35, 1);
// playerBall.acc.x = -0;
// playerBall.acc.y = -1;
