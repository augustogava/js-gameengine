class Line extends BasicForms{
    constructor(x0, y0, x1, y1){
        ...
        this.vertices[0] = new Vertex( new Vector(x0, y0));
        this.vertices[1] = new Vertex(new Vector(x1, y1));
        ...
        this.position = new Vector((this.vertices[0].position.x+this.vertices[1].position.x)/2, (this.vertices[0].position.y+this.vertices[1].position.y/2));
